...
public class ListDatabase extends SQLiteOpenHelper {
    ...
    public Long insert(String recipeName, String ingredients, Integer duration) {
    ...
    public boolean update(Long id, String recipeName, String ingredients, Integer duration) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public List<ProductsList> getproductsList() {
        ...
        if(cursor.getCount() > 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                Integer duration = cursor.getInt(3);
    ...
    public ProductsList getProductList(Long id) {
        SQLiteDatabase db = this.getReadableDatabase();
